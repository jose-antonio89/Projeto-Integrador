...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"> <!--LINK DOS ICONES-->
<link rel="stylesheet" href="css/dark-mode.css">
  ...
  <body>  
    ...
    <div class="container">
      <div class="cabeca">
          <h1>Fotos</h1>
          <p>Demonstre seus trabalhos em Fotos</p>
      </div>

      <div class="btn-container">
          <button class="btn"><span class="icon"></span>Fashion</button>
          <button class="btn"><span class="icon"></span>LifeStyle</button>
          <button class="btn"><span class="icon"></span>Porta-Retratos</button>
          <button class="btn"><span class="icon"></span>Pro</button>
          <button class="btn"><span class="icon"></span>Fotografo de Eventos</button>
      </div>
  </div>
...
?>
   ...
   <div class="see-more-container">
      <a href="allservices.php?id_categoria=<?php echo $id_categoria; ?>" class="see-more-btn">Ver mais serviços de Foto <i class="fas fa-arrow-right"></i></a>
    </div>
<!-------------------------------------------------------------------------------------------------------------->
