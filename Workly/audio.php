...
<link rel="stylesheet" href="css/dark-mode.css">
  ...
  <body>  
    ...
    <div class="container">
      <div class="cabeca">
          <h1>Audio/Musica</h1>
          <p>Demonstre seus trabalhos em Audio e Musica</p>
      </div>

      <div class="btn-container">
          <button class="btn"><span class="icon"></span>Musica</button>
          <button class="btn"><span class="icon"></span>Remixing</button>
          <button class="btn"><span class="icon"></span>Jingles e Intros</button>
          <button class="btn"><span class="icon"></span>Compositores</button>
          <button class="btn"><span class="icon"></span>Narração</button>
      </div>
  </div>
...
?>
   ...
   <div class="see-more-container">
      <a href="allservices.php?id_categoria=<?php echo $id_categoria; ?>" class="see-more-btn">Ver mais serviços de Áudio <i class="fas fa-arrow-right"></i></a>
    </div>
<!-------------------------------------------------------------------------------------------------------------->
